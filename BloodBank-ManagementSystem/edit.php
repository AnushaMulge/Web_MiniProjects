<?php
 ...
 $connection=new mysqli($servername,$username,$password,$database);
    ...
    else
    {
            ...
            do
            {
              if(empty($pid) || empty($pname) || empty($age) || empty($gender) || empty($phno) || empty($address) || empty($pbg) || empty($did) || empty($hid) )
              {
                $errorMessage="All the fields are required";
                break;
              }

              $sql=" UPDATE patient "." SET pname='$pname',age='$age',gender='$gender',phno='$phno',address='$address',pbg='$pbg',did='$did',hid='$hid' "." WHERE pid=$pid ";
             ...
             $sucessMessage="Patient updated sucessfully";
     ...
     <?php
      ...
      <form method="post">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input list="pbg" class="form-control" name="pbg" value="<?php echo $pbg; ?>">
                <datalist id="pbg">
                            <option >O+</option>
                            <option >O-</option>
                            <option>AB+</option>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input list="did" class="form-control" name="did" value="<?php echo $did; ?>">
                <datalist id="did">
                            <option>D1</option>
                            <option>D2</option>
                            <option>D3</option>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input list="hid" class="form-control" name="hid" value="<?php echo $hid; ?>">
                <datalist id="hid">
                            <option>H1</option>
                            <option>H2</option>
                            <option>H3</option>
